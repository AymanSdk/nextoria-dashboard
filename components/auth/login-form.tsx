...
const signUpSchema = z.object({
  ...
  role: z.enum(["Admin", "Marketer", "Designer", "Developer"]).default("Marketer"),
});
            ...
            <div className='mt-4 p-4 bg-gray-50 rounded-lg'>
              ...
              <div className='space-y-2'>
                <div className='flex justify-between items-center text-xs'>
                  ...
                  <span className='text-gray-500'>demo@nextoria.com / demo123</span>
                </div>
                <div className='flex justify-between items-center text-xs'>
                  <span className='font-medium'>Marketer</span>
                  <span className='text-gray-500'>sarah@nextoria.com / sarah123</span>
                </div>
                <div className='flex justify-between items-center text-xs'>
                  <span className='font-medium'>Designer</span>
                  <span className='text-gray-500'>mike@nextoria.com / mike123</span>
                </div>
                <div className='flex justify-between items-center text-xs'>
                  <span className='font-medium'>Developer</span>
                  <span className='text-gray-500'>alex@nextoria.com / alex123</span>
                </div>
              </div>
            </div>
          )}
