...
export default function CampaignsPage() {
  ...
  const getStatusBadge = (status: Campaign['status']) => {
    switch (status) {
      ...
      case 'Finished':
        return <Badge className="bg-gray-100 text-gray-800 hover:bg-gray-100">Finished</Badge>;
      case 'Draft':
        return <Badge className="bg-[#F2EBFD] text-[#894DEF] hover:bg-[#F2EBFD]">Draft</Badge>;
    }
  };
